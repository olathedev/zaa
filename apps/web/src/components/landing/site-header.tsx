  ...
  return (
    <header className="border-t-4 border-[#173f35] bg-white">
      <nav
        ...
        className="mx-auto flex min-h-20 max-w-7xl flex-col justify-center gap-4 px-5 py-5 sm:px-8 lg:min-h-24 lg:flex-row lg:items-center lg:justify-between lg:py-0"
      >
        <a
          href="/"
          aria-label="Zaa AI home"
          className="flex min-h-10 items-center gap-2 text-2xl font-semibold tracking-normal text-[#020617] focus-visible:rounded-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#1769ff] focus-visible:ring-offset-4 sm:text-[1.7rem]"
        >
        ...
        <div className="flex items-center gap-5 overflow-x-auto pb-1 lg:gap-9 lg:overflow-visible lg:pb-0">
          {navItems.map((item) => (
            <a
              key={item}
        ...
        <a
          ...
          className="inline-flex min-h-11 w-fit items-center justify-center gap-2 rounded-lg bg-[#1d2230] px-5 text-[0.95rem] font-medium text-white shadow-sm transition-colors hover:bg-[#1769ff] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#1769ff] focus-visible:ring-offset-4 lg:min-h-12 lg:px-6 lg:text-base"
        >
