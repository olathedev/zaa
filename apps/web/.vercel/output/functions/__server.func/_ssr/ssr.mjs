...
import { i as RouterProvider, l as require_jsx_runtime, t as renderRouterToStream } from "../_libs/@tanstack/react-router+[...].mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DVO9wGN5.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-RyeAdItd.mjs"),
		import("./start-Da0nHh3C.mjs"),
